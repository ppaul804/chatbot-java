...
/**
 * LmStudioService fornece uma API de alto nível para interagir com endpoints de
 * LLM
 ...
 * 
 * <pre>
 * LmStudioService service = new LmStudioService("sk-XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX");
...
public class LmStudioService {
    ...
    private static final String BASE_URL = System.getenv("LM_STUDIO_URL") != null ? System.getenv("LM_STUDIO_URL")
    ...
    /**
     * Creates a new LmStudioService that wraps OpenAiApi
     *
     * @param token OpenAi token string "sk-XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
     */
    public LmStudioService(final String token) {
     ...
     */
    public LmStudioService(final Duration timeout) {
        this("", timeout);
    }
     ...
     * @param timeout http read timeout, Duration.ZERO means no timeout
     */
    public LmStudioService(final String token, final Duration timeout) {
     ...
     */
    public LmStudioService(final OpenAiApi api) {
        this.api = api;
     ...
     */
    public LmStudioService(final OpenAiApi api, final ExecutorService executorService) {
        this.api = api;
